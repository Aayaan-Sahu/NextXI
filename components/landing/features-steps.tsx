...
const STEPS = [
  ...
  },
  {
    ...
    body: "Pose tracking measures stride, arm path, release and front-leg brace on every ball — the same overlays you just scrolled through — and turns them into a readable report.",
    animation: <NeuralNetAnimation />,
  },
  {
    kicker: "03 · Connect",
    title: "Coaches & scouts find you",
    body: "Verified coaches browse player profiles, watch reports, and reach out. Talent gets seen on evidence, not just word of mouth.",
