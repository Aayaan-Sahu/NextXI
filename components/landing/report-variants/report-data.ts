...
export const METRICS: MeasuredMetric[] = [
  ...
  },
  {
    ...
    unit: "cm",
    decimals: 1,
    // Label is the window only — MeasuredMetricRow prefixes "Your range ·".
    reference: { kind: "session", label: "Last 5 sessions", band: [2.6, 3.8] },
    direction: "lower",
  ...
  },
  {
    ...
    unit: "cm",
    decimals: 0,
    reference: { kind: "session", label: "Last 5 sessions", band: [9, 14] },
    direction: "lower",
  ...
  },
  {
    ...
    unit: "m",
    decimals: 2,
    reference: { kind: "session", label: "Last 5 sessions", band: [0.94, 1.05] },
    direction: "none",
  ...
  },
  {
    ...
    unit: "s",
    decimals: 2,
    reference: { kind: "session", label: "Last 5 sessions", band: [0.18, 0.24] },
    direction: "none",
